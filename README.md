...
- **Pilule au bord de l'écran** : trois anneaux concentriques d'usage (session, hebdomadaire tous modèles, hebdomadaire par modèle), une couleur par anneau ou selon le niveau (modéré, vigilance, critique), pourcentage de la session, activité des sessions (en cours, en attente, terminée).
